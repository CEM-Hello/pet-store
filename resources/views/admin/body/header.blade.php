      ...
      <li class="nav-item dropdown">
        <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
          <div class="navbar-profile">
            <img class="img-xs rounded-circle" src="{{ (!empty($adminData->profile_photo_path))? url('upload/admin_images/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" alt="">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
          ...
          <a href="{{ route('admin.change.password') }}" class="dropdown-item preview-item">
            ...
            <div class="preview-item-content">
              <p class="preview-subject mb-1">Update Password</p>
            </div>
          </a>
          <div class="dropdown-divider"></div>
